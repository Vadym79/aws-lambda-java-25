...
abstract class PoolBase
{
   ...
   private void initializeDataSource()
   {
      ...
      System.out.println("New conn jdbc "+jdbcUrl);
      System.out.println("New conn driver class"+driverClassName); 
      System.out.println("New conn dsclass  "+dsClassName);
      
      var ds = config.getDataSource();
      System.out.println("New conn ds "+ds);
      ...
      this.dataSource = ds;
      System.out.println("final ds "+this.dataSource);
   }
